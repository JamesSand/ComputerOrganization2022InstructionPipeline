...
module pipeline_master #(
    ...
    output reg tlb_clear_o // clear tlb
);
...
always_ff @ (posedge clk_i) begin
    if (rst_i) begin
        ...
        // csr instructions
            ...
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
        end else if ((if_id_id_inst_reg[6:0] == 7'b0010011) && (if_id_id_inst_reg[14:12] == 3'b001) && if_id_id_inst_reg[31:25]==0) begin // slli
            id_exe_if_branch_reg <= 0;
            id_exe_wb_csr_we_reg <= 1'b0;
            id_exe_wb_csr_waddr_reg <= 0;
            id_exe_wb_rf_we_reg <= 1'b1;
            ...
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
        end else if ((if_id_id_inst_reg[6:0] == 7'b0010011) && (if_id_id_inst_reg[14:12] == 3'b001) && if_id_id_inst_reg[31:25]==7'b0110000 && if_id_id_inst_reg[24:20]==0) begin // clz
            id_exe_if_branch_reg <= 0;
            id_exe_wb_csr_we_reg <= 1'b0;
            id_exe_wb_csr_waddr_reg <= 0;
            id_exe_wb_rf_we_reg <= 1'b1;
            ...
            id_exe_exe_alu_a_reg <= rf_rdata_a;
            id_exe_exe_alu_b_reg <= imm_gen_i;
            id_exe_exe_alu_op_reg <= `ALU_OP_CLZ;
            id_exe_rd_reg <= if_id_id_inst_reg[11:7];
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
        end else if ((if_id_id_inst_reg[6:0] == 7'b0010011) && (if_id_id_inst_reg[14:12] == 3'b001) && if_id_id_inst_reg[31:25]==7'b0110000 && if_id_id_inst_reg[24:20]==5'b00010) begin // pcnt
            id_exe_if_branch_reg <= 0;
            id_exe_wb_csr_we_reg <= 1'b0;
            id_exe_wb_csr_waddr_reg <= 0;
            id_exe_wb_rf_we_reg <= 1'b1;
            ...
            id_exe_exe_alu_a_reg <= rf_rdata_a;
            id_exe_exe_alu_b_reg <= imm_gen_i;
            id_exe_exe_alu_op_reg <= `ALU_OP_PCNT;
            id_exe_rd_reg <= if_id_id_inst_reg[11:7];
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
            ...
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
        end else if((if_id_id_inst_reg[6:0] == 7'b0110011) && (if_id_id_inst_reg[14:12] == 3'b001)) begin //sbset
            id_exe_if_branch_reg <= 0;
            id_exe_wb_csr_we_reg <= 1'b0;
            id_exe_wb_csr_waddr_reg <= 0;
            id_exe_wb_rf_we_reg <= 1'b1;
            ...
            id_exe_exe_alu_a_reg <= rf_rdata_a;
            id_exe_exe_alu_b_reg <= rf_rdata_b;
            id_exe_exe_alu_op_reg <= `ALU_OP_SBSET;
            id_exe_rd_reg <= if_id_id_inst_reg[11:7];
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
            ...
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
        end else if ((if_id_id_inst_reg[6:0] == 7'b0110011) && (if_id_id_inst_reg[14:12] == 3'b100) && if_id_id_inst_reg[31:25]==7'b0010100) begin // xperm8
            id_exe_if_branch_reg <= 0;
            id_exe_wb_csr_we_reg <= 1'b0;
            id_exe_wb_csr_waddr_reg <= 0;
            id_exe_wb_rf_we_reg <= 1'b1;
            ...
            id_exe_exe_alu_a_reg <= rf_rdata_a;
            id_exe_exe_alu_b_reg <= rf_rdata_b;
            id_exe_exe_alu_op_reg <= `ALU_OP_XP;
            id_exe_rd_reg <= if_id_id_inst_reg[11:7];
            id_exe_exe_exceptionoccur_reg<=0;
            id_exe_mem_tlb_clear_reg <= 0;
...
always_ff @ (posedge clk_i) begin
    if (rst_i) begin
        ...
        exe_mem_mem_tlb_clear_reg <= id_exe_mem_tlb_clear_reg;
...
always_comb begin
    ...
    tlb_clear_o = exe_mem_mem_tlb_clear_reg;
end
